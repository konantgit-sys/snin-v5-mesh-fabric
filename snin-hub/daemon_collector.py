...
KNOW_APPS = {
    ...
    "router_api.py": {"name":"🧭 Smart Router","desc":"Умный маршрутизатор — выбор оптимального пути для сообщений в mesh"},
    ...
    "dao_proxy.py": {"name":"🗳 DAO API","desc":"DAO Proxy (:8082 → DAO :9510)"},
